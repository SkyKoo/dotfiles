...
vim.keymap.set('', '<leader>m', ':%s/<C-V><C-M>//ge<CR>', { noremap = true })
...
-- “,”n 映射 下一个标签
vim.keymap.set('n', '<leader>n', 'gt', { noremap = true })
-- “,”n 映射 上一个标签
vim.keymap.set('n', '<leader>p', 'gT', { noremap = true })
-- “,” 映射 :Te回车 打开新标签
vim.keymap.set('n', '<leader>t', ':Te<CR>', { noremap = true })
